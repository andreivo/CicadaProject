...
//Sensors
const char HTTP_FORM_CONFIG_SENSORS[] PROGMEM = "<form name='frmSensors' method='post' action='/saveSensorsConfig' onsubmit='return validate()'>{cicadalogo}<h1>Cicada DCP Wizard</h1><h2>1.1-4: Sensors Configuration</h2><p id='msg' style='color:red'></p><br><h4>DHT</h4><p>Time slot to collection (minutes)</p><input name='collDHT' value='{collDHT}'><br><h4>DHT - Temperature</h4><p>Code</p><input name='codetemp' value='{codetemp}'><p>DataType</p><input name='dttemp' value='{dttemp}'><br><h4>DHT - Humidity</h4><p>Code</p><input name='codehum' value='{codehum}'><p>DataType</p><input name='dthum' value='{dthum}'><br><h4>Pluviometer</h4><p>Code</p><input name='codeplu' value='{codeplu}'><p>DataType</p><input name='dtplu' value='{dtplu}'><p>Time slot to collection (minutes)</p><input name='collplu' value='{collplu}'><br><h4>Battery Voltage</h4><p>Code</p><input name='codebtv' value='{codebtv}'><p>DataType</p><input name='dtbtv' value='{dtbtv}'><p>Time slot to collection (minutes)</p><input name='collbtv' value='{collbtv}'><br><h4>Battery Current</h4><p>Code</p><input name='codebtc' value='{codebtc}'><p>DataType</p><input name='dtbtc' value='{dtbtc}'><p>Time slot to collection (minutes)</p><input name='collbtc' value='{collbtc}'><br><button type='submit'>Save and Next</button></form>";
const char HTTP_SCRIPT_FORM_CONFIG_SENSORS[] PROGMEM = "<script type='text/javascript'>function validate(){msg.innerHTML='';var e=!0,r=document.forms.frmSensors,n=parseInt(r.codetemp.value),i=r.dttemp.value,t=parseInt(r.collDHT.value),a=parseInt(r.codehum.value),l=r.dthum.value,s=parseInt(r.codeplu.value),u=r.dtplu.value,m=parseInt(r.collplu.value),d=parseInt(r.codebtv.value),o=r.dtbtv.value,v=parseInt(r.collbtv.value),b=parseInt(r.codebtc.value),T=r.dtbtc.value,c=parseInt(r.collbtc.value);return(!n||isNaN(n))&&(msg.innerHTML+='- Code Temp. is required or inválid!<br>',e=!1),i||(msg.innerHTML+='- DataType Temp. is required!<br>',e=!1),(!t||isNaN(t)||5>t||t>60)&&(msg.innerHTML+='- The DHT collection time interval value must be between 5 and 60 min (e.g.: 10)<br>',e=!1),(!a||isNaN(a))&&(msg.innerHTML+='- Code Hum. is required or inválid!<br>',e=!1),l||(msg.innerHTML+='- DataType Hum. is required!<br>',e=!1),(!s||isNaN(s))&&(msg.innerHTML+='- Code Plu. is required or inválid!<br>',e=!1),u||(msg.innerHTML+='- DataType Plu. is required!<br>',e=!1),(!m||isNaN(m)||5>m||m>60)&&(msg.innerHTML+='- The Pluv. collection time interval value must be between 5 and 60 min (e.g.: 10)<br>',e=!1),(!d||isNaN(d))&&(msg.innerHTML+='- Code Bat. Volt. is required or inválid!<br>',e=!1),o||(msg.innerHTML+='- DataType Bat. Volt. is required!<br>',e=!1),(!v||isNaN(v)||5>v||v>60)&&(msg.innerHTML+='- The Bat. Volt. collection time interval value must be between 5 and 60 min (e.g.: 10)<br>',e=!1),(!b||isNaN(b))&&(msg.innerHTML+='- Code Bat. Curr. is required or inválid!<br>',e=!1),T||(msg.innerHTML+='- DataType Bat. Curr. is required!<br>',e=!1),(!c||isNaN(c)||5>c||c>60)&&(msg.innerHTML+='- The Bat. Curr. collection time interval value must be between 5 and 60 min (e.g.: 10)<br>',e=!1),e}var msg=document.getElementById('msg');</script>";
