...
const char HTTP_SCRIPT_FORM_CONFIG_STATION[] PROGMEM = "<script type='text/javascript'>function validate(){msg.innerHTML='';var e=!0,a=document.forms.frmConfig,n=parseFloat(a.vol.value),t=parseFloat(a.sti.value),s=parseFloat(a.smi.value),r=parseFloat(a.lat.value),i=parseFloat(a.lon.value),u=(a.ttr,a.name.value),m=a.spass.value,l=a.suhost.value,o=a.supath.value,g=parseInt(a.suport.value),d=parseInt(a.sudtupdate.value);return(!r||isNaN(r))&&(msg.innerHTML+='- Latitude is required!<br>',e=!1),(!i||isNaN(i))&&(msg.innerHTML+='- Longitude is required!<br>',e=!1),(!n||isNaN(n)||2>n||n>5)&&(msg.innerHTML+='- The calibration value must be between 2.00 and 5.00 (e.g.: 2.47)<br>',e=!1),(!t||isNaN(t)||5>t||t>30)&&(msg.innerHTML+='- The time slot to send must be between 5 and 30 min (e.g.: 10)<br>',e=!1),(!s||isNaN(s)||5>s||s>60)&&(msg.innerHTML+='- The time slot store metadata must be between 5 and 60 min (e.g.: 10)<br>',e=!1),u&&/^([a-z0-9\-\_]+)$/gi.test(u)||(msg.innerHTML+='- Invalid name. Must contain only (aA-zZ), (0-9), (-) or (_)<br>',e=!1),(!m||m.length<8||m.length>64)&&(msg.innerHTML+='- The password must have between 8 and 64 char.<br>',e=!1),l&&!o&&(msg.innerHTML+='- Invalid Path in the host.<br>',e=!1),l&&(!g||isNaN(g)||0>g)&&(msg.innerHTML+='- Invalid port number.<br>',e=!1),l&&(!d||isNaN(d)||0>=d||d>23)&&(msg.innerHTML+='- Daily time to check for updates must be between 0 and 23 hours (e.g.: 10)<br>',e=!1),e}var msg=document.getElementById('msg');</script>";
