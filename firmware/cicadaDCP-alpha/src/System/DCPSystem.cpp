...
void DCPSystem::storeMetadados() {
    if (onTimeToSaveMetadata()) {
        ...
        cicadaSDCard.storeMetadadosStation(STATION_OWNAME, STATION_OWEMAIL, STATION_OWPHONE, STATION_LATITUDE, STATION_LONGITUDE, COM_TYPE, SIM_ICCID, SIM_OPERA, COM_LOCAL_IP, COM_SIGNAL_QUALITTY, FIRMWARE_VERSION, FIRMWARE_DATE);
        nextSlotToSaveMetadata();
        cicadaSDCard.cleanOlderFiles();
    }
}
